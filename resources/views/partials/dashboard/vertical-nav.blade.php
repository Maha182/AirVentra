...
<ul class="navbar-nav iq-main-menu" id="sidebar">
    ...
    <li class="nav-item">
        <a class="nav-link" href="{{route('home')}}">
            <i class="icon">
                <img width="24" height="24" src="https://img.icons8.com/material-two-tone/24/home--v2.png" alt="home--v2"/>
            </i>
            <span class="item-name">Home Page</span>
        </a>
    </li>
    <li class="nav-item">
        <a class="nav-link" href="{{route('OptionsPage')}}">
            <i class="icon">
            <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path opacity="0.4"
            ...
            <span class="item-name">Control Panel</span>
        </a>
    </li> 
...
@if ($user && $user->role === 'admin')
    <li class="nav-item">
        <a class="nav-link" data-bs-toggle="collapse" href="#sidebar-products" role="button" aria-expanded="false"
            ...
            <i class="icon">
                <img width="24" height="24" src="https://img.icons8.com/material-two-tone/24/box.png" alt="box"/>
            </i>
        ...
        <ul class="sub-nav collapse" id="sidebar-products" data-bs-parent="#sidebar">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{route('product_charts')}}">
                    <i class="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                            <g>
                                <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                    ...
                    <span class="item-name">Product charts</span>
                </a>
            </li>
        </ul>
    </li>
...
@if ($user && $user->role === 'employee')
    <li class="nav-item">
            <a class="nav-link" data-bs-toggle="collapse" href="#sidebar-tasks" role="button" aria-expanded="false"
                ...
                <i class="icon">
                    ...
                    <img width="24" height="24" src="https://img.icons8.com/plumpy/24/assignment-turned-in.png" alt="assignment-turned-in"/>
                </i>
            ...
            <ul class="sub-nav collapse" id="sidebar-tasks" data-bs-parent="#sidebar">
                
                <li class="nav-item">
                        <a class="nav-link {{activeRoute(route('task'))}}" href="{{route('task')}}">
                            <i class="icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                    <g>
                                        <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <i class="sidenav-mini-icon"> U </i>
                            <span class="item-name">Tasks List</span>
                        </a>
                </li>
