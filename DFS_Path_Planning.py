...
def build_graph(locations, max_distance=500):  # Increase distance if needed
...
# DFS algorithm to visit all nodes
...
if box_locations:
    ...
    path_indices = dfs(graph, 0)  # Start from first box
...
plt.legend()
plt.title("DFS Path Traversal for Drone")
plt.show()
